...
| ![Public method] | [CountAsync(OperatorStringHandler, CancellationToken)][3] | Returns a number that represents how many elements in the set satisfy a condition. |
| ![Public method] | **CountAsync(String, CancellationToken)**                 | Returns a number that represents how many elements in the set satisfy a condition. |
