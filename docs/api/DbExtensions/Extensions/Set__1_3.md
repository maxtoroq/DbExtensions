Extensions.Set&lt;TResult> Method (DbConnection, SqlBuilder, TextWriter)
========================================================================
Creates and returns a new [SqlSet<TResult>][1] using the provided defining query and logger.
...
```csharp
[ObsoleteAttribute("Please use From<TResult>(SqlBuilder, TextWriter) instead.")]
