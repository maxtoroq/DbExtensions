...
|                            | Name                                      | Description                                                                   |
| -------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------- |
| ![Public Extension Method] | [GetNullableByte(DbDataReader, Int32)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Byte][2]. |
| ![Public Extension Method] | **GetNullableByte(DbDataReader, String)** | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Byte][2]. |
