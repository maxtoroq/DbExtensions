...
|                            | Name                                       | Description                                                                   |
| -------------------------- | ------------------------------------------ | ----------------------------------------------------------------------------- |
| ![Public Extension Method] | **GetNullableGuid(DbDataReader, Int32)**   | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Guid][2]. |
| ![Public Extension Method] | [GetNullableGuid(DbDataReader, String)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Guid][2]. |
