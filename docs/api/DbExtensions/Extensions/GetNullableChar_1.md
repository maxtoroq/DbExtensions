...
|                            | Name                                      | Description                                                                   |
| -------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------- |
| ![Public Extension Method] | [GetNullableChar(DbDataReader, Int32)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Char][2]. |
| ![Public Extension Method] | **GetNullableChar(DbDataReader, String)** | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Char][2]. |
