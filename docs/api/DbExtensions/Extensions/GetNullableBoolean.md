...
|                            | Name                                          | Description                                                                      |
| -------------------------- | --------------------------------------------- | -------------------------------------------------------------------------------- |
| ![Public Extension Method] | **GetNullableBoolean(DbDataReader, Int32)**   | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Boolean][2]. |
| ![Public Extension Method] | [GetNullableBoolean(DbDataReader, String)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Boolean][2]. |
