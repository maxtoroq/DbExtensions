...
![Public method]![Static member] | [EnsureOpen][26]                                                             | Opens the *connection* (if it's not open) and returns an [IDisposable][27] object you can use to close it (if it wasn't open).                                                                                                                                                                                                 
