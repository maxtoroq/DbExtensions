...
|                            | Name                                       | Description                                                                     |
| -------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------- |
| ![Public Extension Method] | [GetNullableFloat(DbDataReader, Int32)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Single][2]. |
| ![Public Extension Method] | **GetNullableFloat(DbDataReader, String)** | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Single][2]. |
