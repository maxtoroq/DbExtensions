...
|                            | Name                                         | Description                                                                      |
| -------------------------- | -------------------------------------------- | -------------------------------------------------------------------------------- |
| ![Public Extension Method] | [GetNullableDecimal(DbDataReader, Int32)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Decimal][2]. |
| ![Public Extension Method] | **GetNullableDecimal(DbDataReader, String)** | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Decimal][2]. |
