...
|                            | Name                                       | Description                                                                    |
| -------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------ |
| ![Public Extension Method] | [GetNullableInt32(DbDataReader, Int32)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Int32][2]. |
| ![Public Extension Method] | **GetNullableInt32(DbDataReader, String)** | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Int32][2]. |
