...
|                            | Name                                      | Description                                                                   |
| -------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------- |
| ![Public Extension Method] | [GetNullableGuid(DbDataReader, Int32)][4] | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Guid][2]. |
| ![Public Extension Method] | **GetNullableGuid(DbDataReader, String)** | Gets the value of the specified column as a [Nullable&lt;T>][1] of [Guid][2]. |
