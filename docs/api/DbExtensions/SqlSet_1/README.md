...
| ![Public method] | [Select&lt;TResult>(SqlFragmentHandler, Func&lt;IDataRecord, TResult>)][41] | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
| ![Public method] | [Select&lt;TResult>(String, Func&lt;IDataRecord, TResult>)][42]             | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
