...
| ![Public method] | [Any(OperatorStringHandler)][10]                                                | Determines whether any element of the set satisfies a condition. <br/>(Inherited from [SqlSet][3])                                                                                                       |
...
| ![Public method] | [Cast(Type)][13]                                                                | Casts the elements of the set to the specified type. <br/>(Inherited from [SqlSet][3])                                                                                                                   |
| ![Public method] | [Cast&lt;TResult>()][14]                                                        | Casts the elements of the set to the specified type. <br/>(Inherited from [SqlSet][3])                                                                                                                   |
| ![Public method] | [Contains(Object)][15]                                                          | Checks the existance of the *entity*, using the primary key value. <br/>(Inherited from [SqlSet][3])                                                                                                     |
...
| ![Public method] | [Count(OperatorStringHandler)][19]                                              | Returns a number that represents how many elements in the set satisfy a condition. <br/>(Inherited from [SqlSet][3])                                                                                     |
...
| ![Public method] | [First(OperatorStringHandler)][23]                                              | Returns the first element in the set that satisfies a specified condition.                                                                                                                               |
...
| ![Public method] | [FirstOrDefault(OperatorStringHandler)][26]                                     | Returns the first element of the set that satisfies a condition or a default value if no such element is found.                                                                                          |
...
| ![Public method] | [LongCount(OperatorStringHandler)][33]                                          | Returns an [Int64][32] that represents how many elements in the set satisfy a condition. <br/>(Inherited from [SqlSet][3])                                                                               |
...
| ![Public method] | [OrderBy(OperatorStringHandler)][35]                                            | Sorts the elements of the set according to the *columnList*.                                                                                                                                             |
| ![Public method] | [OrderBy(String)][36]                                                           | Sorts the elements of the set according to the *columnList*.                                                                                                                                             |
| ![Public method] | [Select(OperatorStringHandler, Type)][37]                                       | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
| ![Public method] | [Select(String, Type)][38]                                                      | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
| ![Public method] | [Select&lt;TResult>(OperatorStringHandler)][39]                                 | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
| ![Public method] | [Select&lt;TResult>(String)][40]                                                | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
| ![Public method] | [Select&lt;TResult>(OperatorStringHandler, Func&lt;DbDataReader, TResult>)][41] | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][3])                                                                                                                      |
...
| ![Public method] | [Single(OperatorStringHandler)][44]                                             | Returns the only element of the set that satisfies a specified condition, and throws an exception if more than one such element exists.                                                                  |
...
| ![Public method] | [SingleOrDefault(OperatorStringHandler)][47]                                    | Returns the only element of the set that satisfies a specified condition or a default value if no such element exists; this method throws an exception if more than one element satisfies the condition. |
...
| ![Public method] | [Where(OperatorStringHandler)][54]                                              | Filters the set based on a predicate.                                                                                                                                                                    |
