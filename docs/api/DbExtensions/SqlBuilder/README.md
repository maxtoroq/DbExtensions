...
![Public method]                 | [LIMIT(Int32)][48]                                | Appends the LIMIT clause using the provided *maxRecords* parameter.                                                                                                                                                                                        
...
![Public method]                 | [OFFSET(Int32)][52]                               | Appends the OFFSET clause using the provided *startIndex* parameter.                                                                                                                                                                                       
