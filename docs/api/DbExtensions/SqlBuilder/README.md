...
| Name                                                                        | Description                                                                                                                                                                                                          |
| --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [_(SqlBuilder.ClauseStringHandler&lt;SqlClause.Current>)][11]               | Appends the interpolated string *handler* to the current clause.                                                                                                                                                     |
...
| [CROSS_JOIN(SqlBuilder.ClauseStringHandler&lt;SqlClause.CROSS_JOIN>)][27]   | Appends the CROSS JOIN clause using the provided interpolated string *handler*.                                                                                                                                      |
| [CROSS_JOIN(String)][28]                                                    | Appends the CROSS JOIN clause using the provided *text*.                                                                                                                                                             |
| [DELETE_FROM(SqlBuilder.ClauseStringHandler&lt;SqlClause.DELETE_FROM>)][29] | Appends the DELETE FROM clause using the provided interpolated string *handler*.                                                                                                                                     |
...
| [FROM(SqlBuilder.ClauseStringHandler&lt;SqlClause.FROM>)][32]               | Appends the FROM clause using the provided interpolated string *handler*.                                                                                                                                            |
...
| [GROUP_BY(SqlBuilder.ClauseStringHandler&lt;SqlClause.GROUP_BY>)][37]       | Appends the GROUP BY clause using the provided interpolated string *handler*.                                                                                                                                        |
...
| [HAVING(SqlBuilder.ClauseStringHandler&lt;SqlClause.HAVING>)][40]           | Appends the HAVING clause using the provided interpolated string *handler*.                                                                                                                                          |
...
| [INNER_JOIN(SqlBuilder.ClauseStringHandler&lt;SqlClause.INNER_JOIN>)][43]   | Appends the INNER JOIN clause using the provided interpolated string *handler*.                                                                                                                                      |
| [INNER_JOIN(String)][44]                                                    | Appends the INNER JOIN clause using the provided *text*.                                                                                                                                                             |
| [INSERT_INTO(SqlBuilder.ClauseStringHandler&lt;SqlClause.INSERT_INTO>)][45] | Appends the INSERT INTO clause using the provided interpolated string *handler*.                                                                                                                                     |
...
| [JOIN(SqlBuilder.ClauseStringHandler&lt;SqlClause.JOIN>)][49]               | Appends the JOIN clause using the provided interpolated string *handler*.                                                                                                                                            |
...
| [LEFT_JOIN(SqlBuilder.ClauseStringHandler&lt;SqlClause.LEFT_JOIN>)][56]     | Appends the LEFT JOIN clause using the provided interpolated string *handler*.                                                                                                                                       |
...
| [LIMIT(SqlBuilder.ClauseStringHandler&lt;SqlClause.LIMIT>)][59]             | Appends the LIMIT clause using the provided interpolated string *handler*.                                                                                                                                           |
...
| [OFFSET(SqlBuilder.ClauseStringHandler&lt;SqlClause.OFFSET>)][63]           | Appends the OFFSET clause using the provided interpolated string *handler*.                                                                                                                                          |
...
| [ORDER_BY(SqlBuilder.ClauseStringHandler&lt;SqlClause.ORDER_BY>)][67]       | Appends the ORDER BY clause using the provided interpolated string *handler*.                                                                                                                                        |
...
| [RIGHT_JOIN(SqlBuilder.ClauseStringHandler&lt;SqlClause.RIGHT_JOIN>)][70]   | Appends the RIGHT JOIN clause using the provided interpolated string *handler*.                                                                                                                                      |
...
| [SELECT(SqlBuilder.ClauseStringHandler&lt;SqlClause.SELECT>)][73]           | Appends the SELECT clause using the provided interpolated string *handler*.                                                                                                                                          |
| [SELECT(String)][74]                                                        | Appends the SELECT clause using the provided *text*.                                                                                                                                                                 |
| [SET(SqlBuilder.ClauseStringHandler&lt;SqlClause.SET>)][75]                 | Appends the SET clause using the provided interpolated string *handler*.                                                                                                                                             |
...
| [UPDATE(SqlBuilder.ClauseStringHandler&lt;SqlClause.UPDATE>)][84]           | Appends the UPDATE clause using the provided interpolated string *handler*.                                                                                                                                          |
| [UPDATE(String)][85]                                                        | Appends the UPDATE clause using the provided *text*.                                                                                                                                                                 |
| [VALUES(SqlBuilder.ClauseStringHandler&lt;SqlClause.VALUES>)][86]           | Appends the VALUES clause using the provided interpolated string *handler*.                                                                                                                                          |
...
| [WHERE(SqlBuilder.ClauseStringHandler&lt;SqlClause.WHERE>)][89]             | Appends the WHERE clause using the provided interpolated string *handler*.                                                                                                                                           |
| [WHERE(String)][90]                                                         | Appends the WHERE clause using the provided *text*.                                                                                                                                                                  |
| [WITH(SqlBuilder.ClauseStringHandler&lt;SqlClause.WITH>)][91]               | Appends the WITH clause using the provided interpolated string *handler*.                                                                                                                                            |
