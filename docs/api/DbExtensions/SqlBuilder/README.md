...
| [AppendClause(SqlClause, String)][16]                                      | Appends the SQL *clause* and the provided *text*.                                                                                                                                                                            |
| [AppendClause&lt;TClause>(SqlBuilder.ClauseStringHandler&lt;TClause>)][17] | Appends the SQL clause identified by TClause and appends the interpolated string *handler*.                                                                                                                                  |
| [AppendClause&lt;TClause>(String)][18]                                     | Appends the SQL clause identified by TClause and appends the *text*.                                                                                                                                                         |
| [AppendLine][19]                                                           | Appends the default line terminator to this instance.                                                                                                                                                                        |
| [AppendSql][20]                                                            | Appends *sql* to this instance.                                                                                                                                                                                              |
| [Clone][21]                                                                | Creates and returns a copy of this instance.                                                                                                                                                                                 |
| [Create(AppendStringHandler)][22]                                          | Initializes a new instance of the **SqlBuilder** class using the provided interpolated string.                                                                                                                               |
| [Create(String)][23]                                                       | Initializes a new instance of the **SqlBuilder** class using the provided text.                                                                                                                                              |
| [CreateStatic(SqlBuilder)][24]                                             | Initializes a new instance of the **SqlBuilder** class using the provided interpolated string. Use this method if you don't expect to modify the returned builder; otherwise, use [Create(AppendStringHandler)][22] instead. |
| [CreateStatic(String)][25]                                                 | Initializes a new instance of the **SqlBuilder** class using the provided text. Use this method if you don't expect to modify the returned builder; otherwise, use [Create(String)][23] instead.                             |
