...
| ![Public method] | [RIGHT_JOIN(SqlInterpolatedStringHandler&lt;SqlClause.RIGHT_JOIN>)][4] | Appends the RIGHT JOIN clause using the provided interpolated string *handler*.                                                                                     |
