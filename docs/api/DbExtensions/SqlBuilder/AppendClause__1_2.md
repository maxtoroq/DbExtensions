...
| ![Public method] | [AppendClause&lt;TClause>(SqlBuilder.ClauseStringHandler&lt;TClause>)][5] | Appends the SQL clause identified by TClause and appends the interpolated string *handler*. |
