...
| ![Public method] | [Count(SqlFragmentHandler)][24]                                             | Returns a number that represents how many elements in the set satisfy a condition. <br/>(Inherited from [SqlSet][4])                                                                                                                       |
...
| ![Public method] | [First(SqlFragmentHandler)][28]                                             | Returns the first element in the set that satisfies a specified condition. <br/>(Inherited from [SqlSet][4])                                                                                                                               |
...
| ![Public method] | [FirstOrDefault(SqlFragmentHandler)][31]                                    | Returns the first element of the set that satisfies a condition or a default value if no such element is found. <br/>(Inherited from [SqlSet][4])                                                                                          |
...
| ![Public method] | [LongCount(SqlFragmentHandler)][38]                                         | Returns an [Int64][37] that represents how many elements in the set satisfy a condition. <br/>(Inherited from [SqlSet][4])                                                                                                                 |
...
| ![Public method] | [OrderBy(SqlFragmentHandler)][40]                                           | Sorts the elements of the set according to the *columnList*. <br/>(Inherited from [SqlSet][4])                                                                                                                                             |
...
| ![Public method] | [Select(SqlFragmentHandler, Type)][47]                                      | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][4])                                                                                                                                                        |
| ![Public method] | [Select(String, Type)][48]                                                  | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][4])                                                                                                                                                        |
| ![Public method] | [Select&lt;TResult>(SqlFragmentHandler)][49]                                | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][4])                                                                                                                                                        |
| ![Public method] | [Select&lt;TResult>(String)][50]                                            | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][4])                                                                                                                                                        |
| ![Public method] | [Select&lt;TResult>(SqlFragmentHandler, Func&lt;IDataRecord, TResult>)][51] | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][4])                                                                                                                                                        |
| ![Public method] | [Select&lt;TResult>(String, Func&lt;IDataRecord, TResult>)][52]             | Projects each element of the set into a new form. <br/>(Inherited from [SqlSet][4])                                                                                                                                                        |
| ![Public method] | [Single()][53]                                                              | The single element of the set. <br/>(Inherited from [SqlSet][4])                                                                                                                                                                           |
| ![Public method] | [Single(SqlFragmentHandler)][54]                                            | Returns the only element of the set that satisfies a specified condition, and throws an exception if more than one such element exists. <br/>(Inherited from [SqlSet][4])                                                                  |
...
| ![Public method] | [SingleOrDefault(SqlFragmentHandler)][57]                                   | Returns the only element of the set that satisfies a specified condition or a default value if no such element exists; this method throws an exception if more than one element satisfies the condition. <br/>(Inherited from [SqlSet][4]) |
...
| ![Public method] | [Where(SqlFragmentHandler)][68]                                             | Filters the set based on a predicate. <br/>(Inherited from [SqlSet][4])                                                                                                                                                                    |
