...
![Public method]                 | [EnsureConnectionOpen][32]                                        | Opens [Connection][33] (if it's not open) and returns an [IDisposable][34] object you can use to close it (if it wasn't open).                                                                                                                                                                                                                                                                                                                     
